...
带**答案遮罩**（模糊 / 纯白）、**点击揭晓**与**长答案自动拆分答案页**的错题本插件。

## 为什么用它 / 核心交互

```text
复习/回看一篇错题笔记时：
  [!answer] 答案块默认是模糊/纯白的 —— 想不起来就先自己想
...
maskStyle: auto # auto/blur/white（mosaic/frosted 后续里程碑）
status: pending
...
> [!answer] 答案较长，已拆分到答案页：[[函数单调性-数学-20250212-1030|查看完整答案 →]]
```
...
- [ ] M3：马赛克（canvas 真像素化）/ 雾面玻璃风格、学科默认风格、统计仪表盘
- [ ] 社区商店发布（需 PR 审查）
